...
function addingSongs() {
    ...
    songs += ` <div class='div1'>
            ...
            <a href="#" class="homePlaylist">Playlist</a> . <a href="#" class="homePlaylist">${movieNameOfKm}</a>
                <br><br>
                <img id='moviePoster' src='${moviePosters}' alt='${movieNameOfKm}'></span>
            ...
            <div class='div2'>
            <p id="id1"><strong>${movieNameOfKm + " Songs"}</strong></p><br><br>
